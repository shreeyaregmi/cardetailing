        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">Crystal Detailing</h3>
                <p className="text-gray-400 text-sm">Premium Car Care</p>
              </div>
            </div>
            <p className="text-gray-400 mb-6">
              Professional automotive detailing services that exceed expectations. 
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-medium">info@crystaldetailing.com</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-white font-medium">Downtown Area</p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 Crystal Detailing. All rights reserved.
            </div>
